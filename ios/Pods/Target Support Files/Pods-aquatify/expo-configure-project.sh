...
with_node \
  ...
  --target "/Users/brokestudent/Desktop/Projects/aquatify/ios/Pods/Target Support Files/Pods-aquatify/ExpoModulesProvider.swift" \
  --entitlement "/Users/brokestudent/Desktop/Projects/aquatify/ios/aquatify/aquatify.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
